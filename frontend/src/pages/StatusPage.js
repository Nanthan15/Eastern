  ...
  return (
    <>
      <style>{`
        ...
        .bookings-card h5 { color:#0D47A1; font-weight:700; margin-bottom:25px; display:flex; align-items:center; gap:10px; }
        .booking-table { border-collapse:collapse; }
        .booking-table thead { background:linear-gradient(135deg,#0D47A1 0%,#00BCD4 100%); color:white; }
        .booking-table thead th { border:none; padding:12px; font-weight:600; letter-spacing:0.5px; }
        .booking-table tbody tr { border-bottom:1px solid #E3F2FD; transition:all 0.2s ease; }
        .booking-table tbody tr:hover { background:#F8FBFF; }
        .booking-table tbody td { padding:12px; vertical-align:middle; }
        .ref-no { font-weight:600; color:#0D47A1; }
        .travel-type { font-weight:600; font-size:15px; }
        .city-route { color:#666; font-size:14px; }
        .status-badge { padding:6px 12px; border-radius:20px; font-weight:600; font-size:12px; text-transform:uppercase; letter-spacing:0.5px; }
        .empty-state { text-align:center; padding:60px 20px; }
        .empty-state-icon { font-size:64px; margin-bottom:20px; }
        .empty-state-text { color:#999; font-size:16px; }
        .full-page-loader { position:fixed; inset:0; background:rgba(0,0,0,0.2); -webkit-backdrop-filter:blur(4px); backdrop-filter:blur(4px); display:flex; align-items:center; justify-content:center; z-index:9999; }
        .full-page-loader dotlottie-wc { width:350px; height:350px; }
      `}</style>
